...
// Delegate for a clipboard-history entry (the `;` launcher mode). Mirrors the
// icon + title + description layout of ActionItem so it matches the rest of
// the launcher. modelData: { name, desc, icon, onClicked(list) }.
Item {
    id: root
